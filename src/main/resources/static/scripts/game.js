...
let currentGamePlayer = params.get('gp');

getGameData(currentGamePlayer);
    ...
    fetch('/api/game_view/' + gpId)
        ...
        .then(json => {
            ...
            data.gamePlayers.forEach(gamePlayer => {
                if (gamePlayer.id == currentGamePlayer) {
                    player = gamePlayer.player;
                } else {
                    opponent = gamePlayer.player;
                }
            })
...
function addShips() {
    ...
    sendShips(ships, currentGamePlayer)
}
